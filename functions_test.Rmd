...
date_range <- as.Date(c(Sys.Date() - days(30), Sys.Date()))
d_tolerance <- 20
ca <- TRUE
...
transhipments <- load_transhipments()

# diff.POSIXt(THP_Date_Received,THP_Transfer_Date) should be < 72h
# diff.POSIXt(Date_Report_Confirmed,Confirmed_Transfer_Date) should be < 72h
