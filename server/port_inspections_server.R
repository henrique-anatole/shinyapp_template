...
output$port_inspections_no_dcd <- renderDT({
  ...
  table_to_show <- datatable(table_to_show, selection = 'none', editable = F, options = append(dt_options, dt_options_local), caption="Port Inspections - no DCD", filter = 'top', width = "auto",
                             extensions = 'Buttons', rownames = FALSE)
